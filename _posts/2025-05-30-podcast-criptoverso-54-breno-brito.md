...
Este episódio do `Criptoverso` é menos uma entrevista temática fechada e mais uma conversa de origem, visão de mundo e interseções. A abertura passa por um resumo longo da minha trajetória: engenharia, mercado financeiro, ciência de dados, traduções de livros, `BIP39` em português, `BitDevs`, hackathons e trabalho com modelos de linguagem voltados a Bitcoin. Isso faz a conversa servir como uma boa página de contexto para quem quer entender por que essas peças acabaram se encontrando no meu trabalho.

{% include generated/podcast-criptoverso-54-breno-brito-chapters.html %}
